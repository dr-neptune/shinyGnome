...
server <- function(input, output, session) {
    ...
    ## (input$bpm * (input$note_length / 4))

    # generate other note length box
    ## observeEvent(input$note_length == c("O"), {
    ##     ## if (input$note_length == "O") {
    ##         insertUI(selector = "#other_notes",
    ##                  where = "beforeEnd",
    ##                  ui = numericInput(inputId = "other_note_selector",
    ...
    ##     ## } else {
    ##     ##     removeUI(selector = "div#other_notes")
    ##     ##     insertUI(selector = "#preNotes",
    ##     ##              where = "beforeEnd",
    ##     ##              ui = div(id = "other_notes"))
    ##     ## }
    ## })
    ...
    observeEvent(input$play, {
        ...
        if (!is.null(rVal$process))
            ...
            bpm <- getNoteValue(input$bpm, input$note_length, input$other_notes_length) ## (input$bpm * (input$note_length / 4));
